...
![react](https://i.imgur.com/8I6IIN5.png)
...
![redux](https://i.imgur.com/1p0oVfW.jpg)
...
<span style="font-size:20px; color:#5882FA"> app.js </span>
...
<span style="font-size:20px; color:#5882FA"> Home.js </span>
...
<span style="font-size:20px; color:#5882FA"> Login.js </span>
...
```
<span style="font-size:20px; color:#5882FA"> Types.js </span>
...
```
<span style="font-size:20px; color:#5882FA"> LoginReducer.js </span>
...
<span style="font-size:20px; color:#5882FA"> LoginAction.js </span>
...
<span style="font-size:20px; color:#5882FA"> redux-thuk </span>

    리덕스를 사용하는 어플리케이션에서 비동기 작업을 처리 할 때 가장 기본적인 
    방법으로는 redux-thunk 라는 미들웨어를 사용하는것입니다.
    이 미들웨어는 리덕스를 개발한 Dan Abramov 가 만든 것이며, 
